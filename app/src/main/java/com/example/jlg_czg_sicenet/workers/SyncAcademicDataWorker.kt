...
class SyncAcademicDataWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            Log.d(TAG, "Starting sync for $dataType, matricula: $matricula")

            // Step 1: Fetch data from network
            Log.d(TAG, "Fetching $dataType data from network...")
            ...
            Log.d(TAG, "Successfully fetched $dataType data, now storing...")
    ...
    companion object {
        const val TAG = "SyncAcademicDataWorker"
